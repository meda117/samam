(() => {
  ...
  function openCouponEditor(coupon) {
    const announcementDefaults = { eyebrow: 'عرض خاص لك', title: 'وفّر في طلبك اليوم', discountLabel: 'خصم', codeLabel: 'كود العرض', copyButton: 'نسخ الكود', termsTitle: 'الشروط والأحكام', terms: ['يُستخدم الكود مرة واحدة لكل عميل.', 'لا يُجمع مع عروض أو أكواد خصم أخرى.'] };
